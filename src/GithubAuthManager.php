...
/**
 * Contains all Simple FB Connect logic that is related to Github interaction.
 */
class GithubAuthManager extends OAuth2Manager {
   ...
   */
  public function __construct(LoggerChannelFactoryInterface $logger_factory, EventDispatcherInterface $event_dispatcher, EntityFieldManagerInterface $entity_field_manager, UrlGeneratorInterface $url_generator, GithubAuthPersistentDataHandler $persistent_data_handler) {
